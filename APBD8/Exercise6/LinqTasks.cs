...
namespace Exercise6
{
    public static class LinqTasks
    {
        ...
        {
            IEnumerable<Emp> result =  CustomExtensionMethods.GetEmployeesWithSubordinates(Emps);
            return result;
        }
        ...
        public static IEnumerable<Dept> Task14()
        {
            IEnumerable<Dept> result =   Depts
                .GroupJoin(Emps, dept => dept.Deptno, emp => emp.Deptno, (dept, emps) => new { Dept = dept, EmpCount = emps.Count() })
